...
import './internals.ts'
import { CONTRACTS_MODIFIED } from './events.ts'
import { createClient, NOTIFICATION_TYPE } from '~/shared/pubsub.ts'
import { merge, cloneDeep, randomHexString, intersection, difference } from '~/shared/giLodash.ts'
    ...
    this.pubsub = createClient(pubsubURL, {
      ...
      messageHandlers: {
        ...
        [NOTIFICATION_TYPE.APP_VERSION] (msg) {
          const ourVersion = Deno.env.get('GI_VERSION')
