...
function minimizeTotalPaymentsCount (distribution: Array<Object>): Array<any | {|from: string, to: string, amount: number|}> {
  // return distribution
  ...
  haversSorted.sort((a, b) => b - a)
  needersSorted.sort((a, b) => b - a)
