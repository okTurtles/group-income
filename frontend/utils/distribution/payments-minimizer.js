...
function minimizeTotalPaymentsCount(distribution: Array<Object>, groupMembers: Array<Object>): Array<any | {| from: string, to: string, amount: number |}> {
  distribution = simpleCopy(distribution)
