...
Vue.component('ChatMembersAllModal', () => lazyLoadView({ component: import('../views/containers/chatroom/ChatMembersAllModal.vue'), loading: LoadingModalFullScreen, error: ErrorModal }))
