  ...
  <div class="section container">
    ...
    <div class="columns is-multiline">
      <div class="column is-4">
        <h2 class="title is-4 c-title">Typography</h2>
        <p class="title is-1">Title is-1</p>
        <p class="title is-2">Title is-2</p>
        <p class="title is-3">Title is-3</p>
        <p class="title is-4">Title is-4</p>
        <p class="title is-5">Title is-5</p>
      </div>

      <div class="column is-4">
        <h2 class="title is-4 c-title">Text</h2>
      ...
      <div class="column is-4">
        <h2 class="title is-4 c-title">Spacing</h2>
        <div class="level"
          v-for="spacer in config.spacings" :key="spacer.name"
        >
          <div class="level level-left">
            <div class="level-item">
              <span class="c-figure":class="`has-spacer-${spacer.name}`"></span>
              <p class="c-code">$spacer-{{ spacer.name }}</p>
            </div>
          </div>
        </div>
      </div>
      ...
      <div class="column is-12">
        <h2 class="title is-4 c-title">Color</h2>
        <div class="columns is-gapless has-text-centered">
          <div class="column" v-for="color in config.colors" :key="color.name">
            <span class="c-palette" :class="`has-background-${color.name}`"></span>
            <p class="c-code">${{ color.name }}</p>
          </div>
        </div>
      </div>
...
.c-title {
  ...
  padding: $gi-spacer 0 $gi-spacer-lg;
