          ...
          <div class="columns is-multiline">
            <div class="column is-one-third has-text-centered create-group">
              ...
              <div class="box">
                ...
                <p class="title is-3 percentage">{{ form.changePercentage }}%</p>
                <input
                  type="range"
                  v-validate
                  ...
                  min="0"
                  max="100"
                  name="form.changePercentage"
                  v-model="form.changePercentage"
                >
                ...
                <input v-if="ephemeral.dev" type="text" v-model="form.changePercentage" name="proxyChangePercentage" style="opacity:0; position: absolute;">
              </div>
            </div>
            <div class="column is-one-third has-text-centered create-group">
              ...
              <div class="box">
                ...
                <p class="title is-3">{{ form.memberApprovalPercentage }}%</p>
                <input
                  type="range"
                  min="0"
                  max="100"
                  ...
                  v-validate
                  data-vv-rules="between:1,100"
                  name="form.memberApprovalPercentage"
                  v-model="form.memberApprovalPercentage"
                >
              ...
              <div class="box">
                ...
                <p class="title is-3">{{ form.memberRemovalPercentage }}%</p>
                <input
                  type="range"
                  min="0"
                  max="100"
                  ...
                  v-validate
                  data-vv-rules="between:1,100"
                  name="form.memberRemovalPercentage"
                  v-model="form.memberRemovalPercentage"
                >
              ...
              <div class="box" >
                ...
                <p class="select">
                  <select
                    ...
                    v-model="form.contributionPrivacy"
                  >
