...
import { KV_EVENT, LOGIN_COMPLETE, LOGIN_ERROR, LOGOUT, NAMESPACE_REGISTRATION, NEW_CURRENT_SYNCS, OFFLINE, ONLINE, OPEN_MODAL, RECONNECTING, RECONNECTION_FAILED, SERIOUS_ERROR, SWITCH_GROUP, THEME_CHANGE } from './utils/events.js'
...
async function startApp () {
  ...
  sbp('okTurtles.events/on', NEW_CURRENT_SYNCS, (currentSyncs) => {
