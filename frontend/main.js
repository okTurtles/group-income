    ...
    contracts: {
      ...
      defaults: {
        ...
        allowedSelectors: [
          ...
          'chelonia/contract/sync', 'chelonia/contract/isSyncing', 'chelonia/contract/isNewSyncing', 'chelonia/contract/remove',
          'controller/router', 'chelonia/queueInvocation', 'gi.actions/identity/updateLoginStateUponLogin',
