  ...
  'state/vuex/getters': (() => {
    ...
    return () => {
      if (!computedGetters) {
        ...
        Object.defineProperties(computedGetters, Object.fromEntries(Object.entries(getters).map(([getter, fn]: [string, Fn]) => {
          return [getter, {
            get: function () {
        ...
        Object.defineProperties(computedGetters, Object.fromEntries(Object.entries(chatroomGetters).map(([getter, fn]: [string, Fn]) => {
          return [getter, {
            get: function () {
              const state = sbp('chelonia/rootState')
        ...
        Object.defineProperties(computedGetters, Object.fromEntries(Object.entries(notificationGetters).map(([getter, fn]: [string, Fn]) => {
          return [getter, {
            get: function () {
              const state = sbp('chelonia/rootState')
              // `state.chatroom` represents the `chatroom` module. For the SW,
