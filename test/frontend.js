...
describe('Frontend', function () {
  ...
  describe('Sign up Test', function () {
    it('Should register User', async function () {
      this.timeout(10000)
      await n.wait(2000).goto(page('signup')).wait('#name')
  ...
  describe('Group Creation Test', function () {
    it('Create Additional User 2', async function () {
      this.timeout(8000)
      const signedup = await n.wait('#LogoutBtn').wait(500)
        .click('#LogoutBtn').wait(500)
        .wait('#SignupBtn')
        .click('#SignupBtn')
        .wait('#name')
    ...
    it('Should Accept Invite', async function () {
      ...
      // Open login modal
        ...
        .wait('#AcceptLink')
        .click('#AcceptLink')
        .wait(() => !!document.getElementById('Processing'))
        .wait(() => !document.getElementById('Processing'))
        .wait('#Inbox')
        .evaluate(() => !!document.getElementById('Inbox'))
      should(success).equal(true)
