...
|}`;
  ...
  async function postLeaveChatRoomCleanup(contractID, state) {
    ...
    (0, import_sbp2.default)("okTurtles.events/emit", NEW_CHATROOM_SCROLL_POSITION, { chatRoomID: contractID });
  }
          ...
          (0, import_sbp3.default)("chelonia/queueInvocation", contractID, async () => {
            ...
            if (memberID === identityContractID) {
              ...
              if (innerSigningContractID !== identityContractID) {
                (0, import_sbp3.default)("gi.actions/chatroom/accept", { contractID, data: null }).catch((e) => {
      ...
      "gi.contracts/chatroom/leave": {
        ...
        async sideEffect({ data, hash, contractID, meta, innerSigningContractID }, { state, getters }) {
          ...
          (0, import_sbp3.default)("chelonia/queueInvocation", contractID, async () => {
            ...
            await (0, import_sbp3.default)("gi.contracts/chatroom/removeForeignKeys", contractID, memberID, state2, getters);
          }).catch((e) => {
      ...
      "gi.contracts/chatroom/deleteMessage": {
        ...
        sideEffect({ data, contractID, innerSigningContractID }, { getters }) {
          ...
          if (rootState.chatroom?.chatRoomScrollPosition?.[contractID] === data.hash) {
            (0, import_sbp3.default)("okTurtles.events/emit", NEW_CHATROOM_SCROLL_POSITION, {
    ...
    methods: {
      ...
      "gi.contracts/chatroom/_postOpHook/ku": ({ contractID, state }) => {
        (0, import_sbp3.default)("chelonia/queueInvocation", contractID, () => {
          return (0, import_sbp3.default)("gi.actions/chatroom/findAndRequestMissingChatroomKeys", contractID);
        }).catch((e) => {
      ...
      "gi.contracts/chatroom/_cleanup": ({ contractID, state }) => {
        if (state?.members) {
          ...
          (0, import_sbp3.default)("chelonia/contract/release", activeMemberIds).catch((e) => {
