...
|}`;
  ...
  var serdesTagSymbol = /* @__PURE__ */ Symbol("tag");
  var serdesSerializeSymbol = /* @__PURE__ */ Symbol("serialize");
  var serdesDeserializeSymbol = /* @__PURE__ */ Symbol("deserialize");
    ...
    actions: {
      ...
      "gi.contracts/identity/leaveGroup": {
        ...
        process({ data }, { state }) {
          ...
          (0, import_sbp3.default)("chelonia/contract/setPendingKeyRevocation", state, ["pek"]);
