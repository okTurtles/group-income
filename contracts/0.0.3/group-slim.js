...
|}`;
  ...
  function archiveProposal({ state, proposalHash, proposal, contractID }) {
    ...
    (0, import_sbp.default)("gi.contracts/group/pushSideEffect", contractID, ["gi.contracts/group/archiveProposal", proposalHash, proposal]);
  }
  ...
  (0, import_sbp2.default)("chelonia/defineContract", {
    ...
    methods: {
      "gi.contracts/group/archiveProposal": async function(proposalHash, proposal) {
        const proposals2 = await (0, import_sbp2.default)("gi.db/archive/load", "proposals") || [];
        proposals2.unshift([proposalHash, proposal]);
        while (proposals2.length > MAX_ARCHIVED_PROPOSALS) {
          proposals2.pop();
        }
        return (0, import_sbp2.default)("gi.db/archive/save", "proposals", proposals2);
      }
    }
  });
})();
