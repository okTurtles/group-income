...
|}`;
  ...
  var validateChatRoomName = (name) => {
    const nameValidationMap = {
      [L("Chatroom name cannot contain white-space")]: (v) => /\s/.test(v),
      [L("Chatroom name cannot contain capital letters")]: (v) => /\p{Lu}/u.test(v),
      [L("Chatroom name cannot contain punctuation or special characters except hyphens")]: (v) => /[^\p{L}\p{M}\p{Nd}-]/u.test(v)
    };
  ...
  var leaveChatRoomAction = async (groupID, state, chatRoomID, memberID, actorID, leavingGroup) => {
    ...
    const groupCSKid = leavingGroup ? await (0, import_sbp4.default)("chelonia/contract/currentKeyIdByName", state, "csk", true) : void 0;
  ...
  (0, import_sbp4.default)("chelonia/defineContract", {
    ...
    actions: {
      ...
      "gi.contracts/group/removeMember": {
        ...
        process({ data, meta, contractID, height, innerSigningContractID }, { state, getters }) {
          ...
          if (memberID !== identityContractID) {
            (0, import_sbp4.default)("chelonia/contract/setPendingKeyRevocation", state, ["cek", "csk"]);
          }
        },
    ...
    methods: {
      ...
      "gi.contracts/group/_postOpHook/ku": ({ contractID, state }) => {
        (0, import_sbp4.default)("chelonia/queueInvocation", contractID, () => {
          return (0, import_sbp4.default)("gi.actions/group/findAndRequestMissingGroupKeys", contractID, state);
        }).catch((e) => {
      ...
      "gi.contracts/group/leaveGroup": async ({ data, meta, contractID, height, getters, innerSigningContractID, proposalHash }) => {
        ...
        if (memberID === identityContractID) {
          ...
          if (isActionNewerThanUserJoinedDate(height, myProfile)) {
            ...
            Promise.resolve().then(() => (0, import_sbp4.default)("gi.contracts/group/rotateKeys", contractID)).then(() => (0, import_sbp4.default)("gi.contracts/group/revokeGroupKeyAndRotateOurPEK", contractID, potentialPEKids)).catch((e) => {
      ...
      "gi.contracts/group/revokeGroupKeyAndRotateOurPEK": (groupContractID, potentialPEKids) => {
        ...
        (0, import_sbp4.default)("chelonia/queueInvocation", identityContractID, async () => {
          await (0, import_sbp4.default)("chelonia/contract/setPendingKeyRevocation", identityContractID, ["pek"], potentialPEKids);
