    ...
    actions: {
      ...
      "gi.contracts/identity/leaveGroup": {
        ...
        process({ data }, { state }) {
          ...
          (0, import_sbp2.default)("chelonia/contract/setPendingKeyRevocation", state, ["pek"]);
      ...
      "gi.contracts/identity/deleteDirectMessage": {
        ...
        process({ contractID, data }, { state }) {
          if (!state.chatRooms?.[data.contractID]) {
            throw new TypeError((0, import_common3.L)("Never joined or already left direct message."));
          }
          if (state.chatRooms[data.contractID].visible) {
