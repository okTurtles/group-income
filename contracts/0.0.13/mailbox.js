  ...
  (0, import_sbp3.default)("chelonia/defineContract", {
    ...
    actions: {
      ...
      "gi.contracts/mailbox/createDirectMessage": {
        ...
        process({ meta, data }, { state }) {
          vue_esm_default.set(state.dms, data.username, {
      ...
      "gi.contracts/mailbox/joinDirectMessage": {
        ...
        process({ meta, data }, { state }) {
          ...
          if (state.attributes.creator === data.username) {
            vue_esm_default.set(state.dms, meta.username, {
              contractID: data.contractID,
              creator: meta.username,
              hidden: false,
              joinedDate
            ...
            vue_esm_default.set(state.dms[data.username], "joinedDate", joinedDate);
          }
        },
      ...
      "gi.contracts/mailbox/leaveDirectMessage": {
        ...
        process({ data }, { state }) {
          vue_esm_default.set(state.dms[data.username], "joinedDate", null);
        },
